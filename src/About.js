...
export default function About() {
  return (
    <Box  style={{margin: '5%',  width: '100%', display: 'flex', alignItems: 'center', flexDirection:"column"}}>
  ...
  <InstagramIcon fontSize="large" sx={{transform: "scale(3)", margin:"3vw"}}/>
  </Link>
  <Link to="/"> 
         
  
         <FacebookIcon fontSize="large" sx={{ transform: "scale(3)", margin:"3vw"  }}/>
                </Link>
  </Grid>
